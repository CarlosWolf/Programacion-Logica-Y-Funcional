...
public class Principal {
   public static void main(String[] args) {
        List<Empleado> listaEmpleados = Arrays.asList(
                new Empleado("Lukas",25,7000,"Sistemas"),
                new Empleado("Skywalker",25,7000,"Sistemas"),
                new Empleado("Juan",35,5000,"Marketing"),
                new Empleado("Joshua",30,4000,"Diseño"),
                new Empleado("Tommy",29,1500,"Ventas"),
                new Empleado("Pedro",27,4000,"Diseño"),
                new Empleado("Maria",19,1500,"Mostrador")
        );
